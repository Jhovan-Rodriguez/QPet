            ...
            <div class="carousel-inner">
                    ...
                    <div class="row row-cols-1 row-cols-md-3 g-4 m-3 ">
                        <div class="col">
                            <div class="card card-v">
                                <img src="{{ asset('img/vet/vet1.jpg') }}" class="card-img-top" alt="..."
                                    height="250">
                                <div class="card-body-v d-flex flex-column justify-content-center text-center">
                                    ...
                                    <p class="card-text" style="font-size: 15px;">Some quick example text to build on the
                                        card title and make up the bulk of the card's content.</p>
                                    <p class="card-text  mb-5" style="font-size: 15px;">
                                        <svg style="height: 25px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                        ...
                        <div class="col">
                            <div class="card card-v">
                                <img src="{{ asset('img/vet/vet2.jpg') }}" class="card-img-top" alt="..."
                                    height="250">
                                <div class="card-body-v d-flex flex-column justify-content-center text-center">
                                    <h5 class="card-title text-center text-white text-bold mb-2">Card title</h5>
                                    <p class="card-text" style="font-size: 15px;">Some quick example text to build on the
                        ...
                        <div class="col">
                            <div class="card card-v">
                                <img src="{{ asset('img/vet/vet3.jpg') }}" class="card-img-top" alt="..."
                                    height="250">
                                <div class="card-body-v d-flex flex-column justify-content-center text-center">
                                    <h5 class="card-title text-center text-white text-bold mb-2">Card title</h5>
                                    <p class="card-text" style="font-size: 15px;">Some quick example text to build on the
                ...
                <div class="carousel-item ">
                    <div class="row row-cols-1 row-cols-md-3 g-4 m-3 ">
                        <div class="col">
                            <div class="card card-v">
                                <img src="{{ asset('img/vet/vet4.jpg') }}" class="card-img-top" alt="..."
                                    height="250">
                                <div class="card-body-v d-flex flex-column justify-content-center text-center">
                                    <h5 class="card-title text-center text-white text-bold mb-2">Card title</h5>
                                    <p class="card-text" style="font-size: 15px;">Some quick example text to build on the
    ...
    <section class="section">
        ...
        <div class="form-search" style="display: flex;">
            <input type="text" class="form-control" placeholder="Search anything..."
                style="border-radius: 20px 0 0 20px; background-color: #C5E0E0;  width: 60%; border: 1px solid #C5E0E0 ">
            <button class="btn" type="submit"
                style="border-radius: 0 20px 20px 0; background-color: #74B0B0; color: white; outline: 0px; margin-right:24%">
                <svg style="height: 20px; width: 20px; " xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <button class="btn" type="submit"
                style="border-radius: 15px; background-color: #74B0B0; color: white; outline: 0px; width: 6%; padding:5px">
                <svg style="height: 30px; width: 30px; " xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            @foreach ($veterinarias as $veterinaria)
                <div class="col">
                    <div class="card card-h mb-3" style="max-width: 540px">
                        <div class="row g-0">
                            <div class="col-md-5">
                                <img src="{{ asset('img/vet/vet4.jpg') }}" class="img-fluid " alt="..."
                            ...
                            <div class="col-md-7">
                                <div class="card-body d-flex flex-column justify-content-center text-center text-white">
                                    <h5 class="card-title text-center text-white text-bold mb-2">{{$veterinaria->nombre}}</h5>
                                    <p class="card-text  mb-5" style="font-size: 15px;">
                                        <svg style="height: 25px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                            fill="currentColor" class="w-6 h-6">
                                            <path fill-rule="evenodd"
                                        ...
                                        Col. {{$veterinaria->colonia}}, Calle {{$veterinaria->calle}} <br>
                                        Num ext. {{$veterinaria->num_ext}}
                                    </p>

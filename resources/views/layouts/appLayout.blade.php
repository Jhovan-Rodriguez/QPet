        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="collapse navbar-collapse" id="sidebar-parent">
                <ul class="navbar-nav iq-main-menu py-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="{{route('misMascotas')}}">
                            <i class="icon">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="{{route('adopcion')}}">
                            <i class="icon">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-clipboard-heart" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
